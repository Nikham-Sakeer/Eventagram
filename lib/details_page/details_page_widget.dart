  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<EventsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventsRecord> detailsPageEventsRecordList = snapshot.data!;
        // Return an empty Container when the document does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final detailsPageEventsRecord = detailsPageEventsRecordList.isNotEmpty
            ? detailsPageEventsRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<EventsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<EventsRecord>
                                        textLocationEventsRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the document does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final textLocationEventsRecord =
                                        textLocationEventsRecordList.isNotEmpty
                                            ? textLocationEventsRecordList.first
                                            : null;
                                    return Text(
                        ...
                        Padding(
                          ...
                          child: StreamBuilder<EventsRecord>(
                            stream: EventsRecord.getDocument(
                                detailsPageEventsRecord!.reference),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
